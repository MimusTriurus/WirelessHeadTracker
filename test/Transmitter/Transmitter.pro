...
### ParamsProvider
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../../lib/static/ParamsProvider/release/ -lParamsProvider
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../../lib/static/ParamsProvider/debug/ -lParamsProvider
else:unix:!macx: LIBS += -L$$OUT_PWD/../../lib/static/ParamsProvider/ -lParamsProvider

INCLUDEPATH += $$PWD/../../lib/static/ParamsProvider
DEPENDPATH += $$PWD/../../lib/static/ParamsProvider

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/ParamsProvider/release/libParamsProvider.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/ParamsProvider/debug/libParamsProvider.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/ParamsProvider/release/ParamsProvider.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/ParamsProvider/debug/ParamsProvider.lib
else:unix:!macx: PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/ParamsProvider/libParamsProvider.a
